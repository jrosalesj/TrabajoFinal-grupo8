...
public class SONYPanelProducto extends JFrame implements ProductosFactory{
    ...
    int productoId=0;
    ProductosDatos productosDatosSONY = new ProductosDatos();
    ...
    public void agregarProducto(){
        ...
        productosDatosSONY.crearProducto(p);

        productoTxtNombre.setText("");
        productoTxtPrecio.setText("");

        List<Productos> miLista = productosDatosSONY.getListaProductos();
